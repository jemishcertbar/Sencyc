    ...
    <nav class="nav">
      <div class="nav-section${workspaceOpen ? " open" : ""}" data-section="workspace">
        ...
        <div class="nav-section-items">
          <a class="nav-item active" data-view="overview" data-tooltip="Overview" title="Overview" href="${homeLink}"><span class="nav-icon">${sidebarIcon("overview")}</span><span class="nav-label-text">Overview</span></a>
          <a class="nav-item" data-view="search" data-tooltip="Global search" title="Global search" href="${pagePrefix}search.html"><span class="nav-icon">${sidebarIcon("search")}</span><span class="nav-label-text">Global search</span></a>
          <a class="nav-item" data-view="assets" data-tooltip="Assets" title="Assets" href="${pagePrefix}assets.html"><span class="nav-icon">${sidebarIcon("assets")}</span><span class="nav-label-text">Assets</span><span class="nav-count">248</span></a>
          <a class="nav-item" data-view="findings" data-tooltip="Findings" title="Findings" href="${pagePrefix}findings.html"><span class="nav-icon">${sidebarIcon("findings")}</span><span class="nav-label-text">Findings</span><span class="nav-count alert">12</span></a>
          <a class="nav-item" data-view="watchlists" data-tooltip="Watchlists" title="Watchlists" href="${pagePrefix}watchlists.html"><span class="nav-icon">${sidebarIcon("watchlists")}</span><span class="nav-label-text">Watchlists</span></a>
          <a class="nav-item" data-view="alerts" data-tooltip="Alerts" title="Alerts" href="${pagePrefix}alerts.html"><span class="nav-icon">${sidebarIcon("alerts")}</span><span class="nav-label-text">Alerts</span><span class="nav-count">4</span></a>
        </div>
      </div>
      <div class="nav-section${manageOpen ? " open" : ""}" data-section="manage">
        ...
        <div class="nav-section-items">
          <a class="nav-item" data-view="reports" data-tooltip="Reports" title="Reports" href="${pagePrefix}reports.html"><span class="nav-icon">${sidebarIcon("reports")}</span><span class="nav-label-text">Reports</span></a>
          <a class="nav-item" data-view="integrations" data-tooltip="Integrations" title="Integrations" href="${pagePrefix}integrations.html"><span class="nav-icon">${sidebarIcon("integrations")}</span><span class="nav-label-text">Integrations</span></a>
          <a class="nav-item" data-view="settings" data-tooltip="Settings" title="Settings" href="${pagePrefix}settings.html"><span class="nav-icon">${sidebarIcon("settings")}</span><span class="nav-label-text">Settings</span></a>
        </div>
      </div>
    </nav>
